...
Метод обнаружения угроз: использование системы мониторинга сетевой активности и обнаружения аномального поведения./
    5.	Планирование обслуживания и обновлений:/
...
**7. Штрафные санкции и вознаграждения**
    ...
    1.	Штрафные санкции: в случае недоступности сервера в течение месяца менее 99.95%, клиент имеет право на компенсацию в размере 10% от ежемесячной стоимости услуги за каждый процент недоступности ниже установленного уровня./
Если поставщик услуг не реагирует на критические события в течение 2 часов, штраф составляет 5% от ежемесячной стоимости услуги за каждый случай нарушения./
    2.	Вознаграждения: в случае превышения ожидаемого уровня обслуживания получатель услуг может предоставить поставщику бонусное вознаграждение./
    3.	Условия применения штрафов и вознаграждений:/
    ...
    4.	Обновление SLA: условия SLA могут пересматриваться и обновляться с учетом изменений в бизнес-требованиях и оценке эффективности предоставляемых услуг. При пересмотре SLA учитываются предыдущие нарушения и санкции, принятые в отношении поставщика услуг.
